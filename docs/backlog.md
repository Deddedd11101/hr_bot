...
| `HRB-DISC-06` | `doing` | Архив и повторный приход кандидата | Draft подготовлен; согласовать архив, отмену доставок, связь попыток и политику хранения/статистики до реализации. См. [[features/archive-reentry-proposal]]. |
