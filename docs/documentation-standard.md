...
| `audit` | Разовый аудит/ревизия состояния, рисков или расхождений. Не заменяет live docs. | `false` |
...
- `audit`-документы фиксируют разовый анализ. Подтвержденные выводы из них нужно переносить в live docs или decisions.
