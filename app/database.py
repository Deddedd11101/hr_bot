...
def _ensure_sqlite_schema() -> None:
    ...
    with engine.begin() as conn:
        ...
        if not progress_table_info:
            conn.execute(
                text(
                    ...
                    CREATE TABLE scenario_progress (
                        ...
                        pending_confirmation_step_key TEXT,
            ...
            if "pending_confirmation_step_key" not in progress_columns:
                conn.execute(text("ALTER TABLE scenario_progress ADD COLUMN pending_confirmation_step_key TEXT"))
